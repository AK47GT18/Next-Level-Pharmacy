...
class MobileMenu
{
    ...
    private function renderUserProfile(): string
    {
        ...
        $profileUrl = "?page=settings&view=user-profile";

        return <<<HTML
        <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-white/10">
            <div onclick="window.location.href='{$profileUrl}'" class="flex items-center gap-3 p-3 bg-white/10 rounded-xl cursor-pointer hover:bg-white/20 transition">
