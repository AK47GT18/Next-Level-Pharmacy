...
class EditProductModal
{
    ...
    public function render(): string
    {
        ...
        return <<<HTML
<div id="{$modalId}" class="fixed inset-0 z-50 hidden overflow-y-auto items-start md:items-center justify-center p-4 transition-all duration-300" style="display: none;">
