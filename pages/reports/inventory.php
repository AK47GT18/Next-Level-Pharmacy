...
try {
    ...
    foreach ($products as $product) {
        ...
        $stockValue += (float)($product['cost_price'] ?? 0) * (int)$product['stock'];
    }
...
<div class="space-y-6">
    ...
    <div class="glassmorphism rounded-2xl p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="?page=reports&view=inventory&stock_level=low" class="px-4 py-2 text-amber-600 bg-amber-50 rounded-xl text-sm font-semibold hover:bg-amber-100 transition-all">
                View All
            </a>
        </div>
    ...
    <div class="glassmorphism rounded-2xl p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <form method="GET" class="flex items-center gap-3">
                ...
                <select name="category" class="rounded-xl border-gray-300 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                ...
                <select name="stock_level" class="rounded-xl border-gray-300 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                ...
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-xl text-sm font-semibold hover:bg-blue-700 transition-all">
                    <i class="fas fa-filter mr-1"></i>Apply
                </button>
                
                <?php if ($categoryFilter || $stockFilter): ?>
                <a href="?page=reports&view=inventory" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-xl text-sm font-semibold hover:bg-gray-200 transition-all">
                    ...
                    <?php else: ?>
                        <?php foreach ($products as $product): ?>
                            <?php
                                ...
                                $itemValue = ($product['cost_price'] ?? 0) * $product['stock'];
                            ?>
